...
import { FilterChangedEvent, IAfterGuiAttachedParams } from 'ag-grid-community';
import { faFilter } from '@fortawesome/free-solid-svg-icons';
import { ITextFloatingFilterProps as IFloatingFilterProps, ITextFloatingFilterRef } from './types';
...
function FloatingFilter(props: IFloatingFilterProps, ref: ForwardedRef<ITextFloatingFilterRef>) {
  ...
  useImperativeHandle(ref, () => {
    return {
      ...
      // that the grid fires.
      onParentModelChanged(parentModel: number | null, event: FilterChangedEvent) { },
