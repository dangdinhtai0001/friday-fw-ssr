    ...
    applyFieldDisabled(fieldStatus: FieldStatus): void {
      setContext((prevContext: ContextState) => {
        ...
        const updatedContext: ContextState = {
          ...
          fieldDisabled: Object.assign(
            {},
            prevContext.fieldDisabled,
            fieldStatus
          ),
        };
        return updatedContext;
    ...
    applyFieldReadOnly(fieldStatus: FieldStatus): void {
      setContext((prevContext: ContextState) => {
        ...
        const updatedContext: ContextState = {
          ...
          fieldReadOnly: Object.assign(
            {},
            prevContext.fieldReadOnly,
            fieldStatus
          ),
        };
        return updatedContext;
    ...
    applyFieldHidden(fieldStatus: FieldStatus): void {
      setContext((prevContext: ContextState) => {
        ...
        const updatedContext: ContextState = {
          ...
          fieldHidden: Object.assign(
            {},
            prevContext.fieldHidden,
            fieldStatus
          ),
        };
        return updatedContext;
    ...
    applyFieldMessage(
      ...
      setContext((prevContext: ContextState) => {
        const updatedContext: ContextState = {
          ...prevContext,
          fieldMessage: fields
            ? Object.assign({}, prevContext.fieldMessage, fields)
            : {},
        };
        return updatedContext;
      });
