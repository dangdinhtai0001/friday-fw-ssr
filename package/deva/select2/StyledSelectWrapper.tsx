...
export const StyledListbox = styled('ul', {})(({ theme }: { theme?: IDefaultTheme }) => ({
  listStyle: 'none',
...
export const StyledOption = styled('li', {})(({ theme }: { theme?: IDefaultTheme }) => ({
...
export const StyledOptionGroupRoot = styled('li', {})(({ theme }: { theme?: IDefaultTheme }) => ({
  listStyle: 'none',
  paddingLeft: 0,
...
export const StyledOptionGroupList = styled('ul', {})(({ theme }: { theme?: IDefaultTheme }) => ({
  listStyle: 'none',
  paddingLeft: 0,
...
export const StyledOptionGroupLabel = styled('div', {})(({ theme }: { theme?: IDefaultTheme }) => ({
