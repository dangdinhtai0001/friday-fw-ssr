...
export const StyledTabsList = styled(
  TabsList,
  {}
)(({ theme }: { theme?: IDefaultTheme }) => ({
  display: 'flex',
...
export const StyledTabUnderline = styled(
  'div',
  {}
)<IStyledTabUnderlineProps>(
  ({ theme }: IStyledTabUnderlineProps) => ({
    bottom: '-1px',
    left: '0',
    right: 0,
    height: '3px',
