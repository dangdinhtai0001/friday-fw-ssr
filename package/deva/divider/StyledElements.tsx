...
export const StyledDividerContainer = styled(
  'div',
  {}
)(
  ({
...
export const StyledDividerLine = styled(
  'div',
  {}
)(
  ({
...
export const StyledDividerText = styled(
  'div',
  {}
)(({ theme, color }: { theme?: IDefaultTheme; color?: string }) => ({
